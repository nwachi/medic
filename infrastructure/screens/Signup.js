            ...
            <View style={styles.container}>
                <ScrollView>
                  ...
                  <Button
                     ...
                     <Text style={styles.subHeading}> {accountType == 'individual'? 'Create an Individual account': 'Create provider account'}</Text>
                     ...
                     secureTextEntry={true}
                     />
                     {/* only show input if account type is provider*/}
                     {
